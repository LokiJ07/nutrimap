...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function disableInputs() {
        document.querySelectorAll("input").forEach(input => {
            if (input.id !== "csvFile") input.disabled = true;
        });
    }
    ...
    requiredInputs.forEach(input => input.addEventListener("input", checkManualCompletion));
    checkManualCompletion(); // run on page load
    ...
    csvFileInput.addEventListener("change", function(e) {
        ...
        reader.onload = function(event) {
            ...
            // Mapping of CSV values to input names
            const inputMapping = [
