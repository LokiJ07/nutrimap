...
<body class="flex flex-col min-h-screen">
    ...
    <!-- Main Content -->
    <main class="main-content flex-grow flex flex-col items-center p-5 lg:p-10">
        <h1 class="text-3xl lg:text-4xl font-bold mb-8 text-gray-800 text-center">About CNO NutriMap</h1>
        ...
        <section class="sdg-section">
            <h2 class="text-3xl lg:text-4xl font-bold mb-8 text-gray-800 text-center">Our Contribution to the SDGs</h2>
            <div class="sdg-container">
                <div class="sdg-goal">
                    <h3 class="font-bold text-xl text-teal-600">SDG 2: Zero Hunger</h3>
                ...
                <div class="sdg-goal">
                    <h3 class="font-bold text-xl text-teal-600">SDG 3: Good Health and Well-being</h3>
                    <p class="text-gray-600">
