...
<body class="flex flex-col min-h-screen bg-gray-100 font-sans">
  ...
  <!-- Footer -->
  <footer class="mt-auto bg-teal-600 text-white text-center py-4">
    <div class="flex justify-center space-x-6 text-sm font-semibold mb-2 flex-wrap">
      <a href="privacy_act/terms.php" class="hover:underline">Terms</a>
      <a href="privacy_act/privacy.php" class="hover:underline">Privacy Policy</a>
      <a href="privacy_act/cookies.php" class="hover:underline">Cookies</a>
      <a href="privacy_act/help.php" class="hover:underline">Help</a>
      <a href="privacy_act/faqs.php" class="hover:underline">FAQs</a>
    </div>
    <p class="text-xs">
