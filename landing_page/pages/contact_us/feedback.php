...
<head>
    ...
    <title>Feedback - CNO NutriMap</title>
...
<body class="flex flex-col min-h-screen bg-gray-100 text-gray-800">
    ...
    <main class="flex-grow flex flex-col items-center px-4 py-10 lg:px-20 text-center">
        <section class="w-full max-w-2xl bg-white rounded-lg shadow-lg p-8">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Send Us Your Feedback</h1>
            <p class="text-gray-600 mb-6">
                Mahalaga sa amin ang inyong opinyon. Makakatulong ito sa pagpapabuti ng aming mga serbisyo.
            </p>

            <form action="#" method="POST" class="w-full">
                <div class="mb-4 text-left">
                    <label for="name" class="block text-sm font-semibold text-gray-700 mb-1">Pangalan</label>
                ...
                <div class="mb-4 text-left">
                    ...
                    <input type="text" id="subject" name="subject" required class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a0a0] transition-colors">
                </div>
                <div class="mb-4 text-left">
                    <label for="feedback" class="block text-sm font-semibold text-gray-700 mb-1">Ang Iyong Feedback</label>
                    <textarea id="feedback" name="feedback" rows="7" required class="w-full p-3 border border-gray-300 rounded-lg resize-y focus:outline-none focus:ring-2 focus:ring-[#00a0a0] transition-colors"></textarea>
                </div>
