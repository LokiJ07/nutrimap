...
<body class="flex flex-col min-h-screen bg-gray-100 text-gray-800">
    ...
    <main class="flex-grow flex flex-col items-center px-4 py-10 lg:px-20 text-center">
        <section class="w-full max-w-4xl bg-white rounded-lg shadow-lg p-8 text-left">
            <h1 class="text-3xl font-bold text-gray-800 mb-4 text-center">Frequently Asked Questions (FAQs)</h1>
            <p class="text-gray-600 mb-6 text-center">
                Narito ang mga sagot sa mga madalas na katanungan tungkol sa CNO NutriMap.
            </p>

            <div class="space-y-6">
                <div>
                    <h2 class="text-xl font-semibold text-gray-700 mb-2">1. Ano ang CNO NutriMap?</h2>
                    <p class="text-gray-600">
                        Ang CNO NutriMap ay isang tool na naglalayong mag-visualize ng health at nutrition data ng mga bata sa El Salvador City sa pamamagitan ng isang interactive na mapa.
                    </p>
                </div>
                <div>
                    <h2 class="text-xl font-semibold text-gray-700 mb-2">2. Paano ako makakahanap ng data sa mapa?</h2>
                    <p class="text-gray-600">
                        Maaari ninyong gamitin ang search bar at mga filter sa Map page upang hanapin ang partikular na data ng nutritional status sa bawat barangay o purok.
                    </p>
                </div>
                <div>
                    <h2 class="text-xl font-semibold text-gray-700 mb-2">3. Ligtas ba ang aking personal na impormasyon?</h2>
                    <p class="text-gray-600">
                        Opo, mahalaga sa amin ang inyong privacy. Ginagamit namin ang iba't ibang security measures upang protektahan ang inyong datos. Para sa karagdagang impormasyon, basahin ang aming <a href="../../pages/legal_and_support/privacy_policy.php" class="text-[#00a0a0] underline hover:text-[#008c8c] transition-colors">Privacy Policy</a>.
                    </p>
                </div>
                <div>
                    <h2 class="text-xl font-semibold text-gray-700 mb-2">4. Paano ako makakapagbigay ng feedback?</h2>
                    <p class="text-gray-600">
                        Maaari kayong magpadala ng feedback sa amin sa pamamagitan ng <a href="../../pages/contact_us/feedback.php" class="text-[#00a0a0] underline hover:text-[#008c8c] transition-colors">Feedback page</a>.
                    </p>
                </div>
                <div>
                    <h2 class="text-xl font-semibold text-gray-700 mb-2">5. Mayroon bang downloadable forms?</h2>
                    <p class="text-gray-600">
                        Opo, mayroon. Maaari ninyong i-access at i-download ang iba't ibang forms mula sa aming <a href="../../pages/contact_us/downloadable_form.php" class="text-[#00a0a0] underline hover:text-[#008c8c] transition-colors">Downloadable Forms page</a>.
                    </p>
                </div>
            </div>
        </section>
