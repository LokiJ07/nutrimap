...
<body class="flex flex-col min-h-screen bg-gray-100 text-gray-800">
    ...
    <main class="flex-grow flex flex-col items-center px-4 py-10 lg:px-20 text-center">
        <section class="w-full max-w-4xl bg-white rounded-lg shadow-lg p-8 text-left">
            <h1 class="text-3xl font-bold text-gray-800 mb-4 text-center">Help & Support</h1>
            <p class="text-gray-600 mb-6 text-center">
                Narito ang ilang paraan kung paano namin kayo matutulungan. Kung hindi ninyo makita ang sagot na hinahanap, huwag mag-atubiling makipag-ugnayan sa amin.
            </p>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-semibold text-gray-700 mb-2">FAQs</h2>
                    <p class="text-gray-600 mb-4">
                        Para sa mabilis na sagot sa mga madalas itanong, bisitahin ang aming <a href="../../pages/help_and_support/faqs.php" class="text-[#00a0a0] underline hover:text-[#008c8c] transition-colors">FAQs page</a>.
                    </p>
                </div>
                <div>
                    <h2 class="text-2xl font-semibold text-gray-700 mb-2">Makipag-ugnayan sa Amin</h2>
                    <p class="text-gray-600 mb-4">
                        Para sa personal na tulong, maaari ninyo kaming i-contact sa pamamagitan ng aming <a href="../../pages/contact_us/get_in_touch.php" class="text-[#00a0a0] underline hover:text-[#008c8c] transition-colors">Contact Page</a>.
                    </p>
                </div>
            </div>
            
            <div class="mt-8">
                <h2 class="text-2xl font-semibold text-gray-700 mb-2">Technical Support</h2>
                <p class="text-gray-600">
                    Kung mayroon kayong teknikal na problema, mangyaring magpadala ng email sa technical_support@cnonutrimap.com at bibigyan namin kayo ng tulong sa lalong madaling panahon.
                </p>
            </div>
        </section>
    </main>
